...
export default function ProductDetailsView({
  ...
  return (
    <section className="mx-auto grid max-w-7xl gap-10 px-4 py-10 md:px-6 lg:grid-cols-[1fr_1fr]">
      ...
      <div className="space-y-6">
        ...
        {product.productType === "variable" && product.variants.length > 0 ? (
          <div className="space-y-3">
            <h2 className="text-lg font-semibold text-black">Choose Variant</h2>
