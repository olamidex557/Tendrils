...
export default function AdminEditCategoryPage() {
  const [form, setForm] = useState({
    ...
    slug: "electronics",
    description:
      "Browse gadgets, accessories, devices, and home tech essentials curated for modern shopping.",
    imageUrl:
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
    console.log("Updated category payload:", form);
    alert("Category update captured. Database wiring comes next.");
  }
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-stone-600">
              Update this category’s storefront information and visibility.
            </p>
          </div>
      ...
      <form onSubmit={handleSubmit} className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-6">
          <CardShell
            ...
            subtitle="Update category details and storefront setup."
          >
...
transition focus:border-black/30"
          ...
          <CardShell
            ...
            subtitle="Update the display image for this category."
          >
            <div className="space-y-5">
              <Field
                label="Image URL"
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                <p className="text-sm font-medium text-black">
                  Ready to update this category?
                </p>
                <p className="text-sm text-stone-500">
                  Review the preview and save changes when ready.
                </p>
              </div>
...
font-medium text-amber-700">
          ...
          <CardShell
            title="Edit Summary"
            subtitle="Snapshot of the current category setup."
          >
          ...
          >
            <div className="flex items-center gap-3 rounded-2xl bg-stone-50 p-4">
              ...
              <div>
                <p className="text-sm font-semibold text-black">1 hour ago</p>
