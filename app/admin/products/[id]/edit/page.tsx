...
export default function AdminEditProductPage() {
  const [form, setForm] = useState({
    ...
    shortDescription: "Soft premium cotton tee available in multiple colors and sizes.",
    description:
  "A clean everyday essential designed for comfort, easy styling, and long-lasting wear. Built as a variable product with size and color combinations.",
    productType: "variable" as ProductType,
  });

  const [attributes, setAttributes] = useState<AttributeRow[]>([
    { id: makeId(), name: "Size", values: "S, M, L" },
    { id: makeId(), name: "Color", values: "Black, White" },
  ]);
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    alert("Product updates captured. Database wiring comes next.");
  }
                ...
                <div className="mb-5 flex flex-wrap gap-2">
                  {attributePresets.map((preset) => (
                    <button
                      ...
                      className="rounded-full bg-stone-100 px-4 py-2 text-sm text-stone-700 transition 
                      ...
                      <div className="grid gap-4 md:grid-cols-[0.9fr_1.5fr_auto]">
                        <div>
                          ...
                          <input
                            ...
                            className="h-12 w-full rounded-2xl border border-stone-200 bg-white px-4 text-sm 
        ...
        <div className="space-y-6">
          ...
          >
            <div className="flex items-center gap-3 rounded-2xl bg-stone-50 p-4">
              ...
              <div>
                <p className="text-sm font-semibold text-black">2 hours ago</p>
          ...
          <div className="rounded-[1.5rem] border border-black/5 bg-stone-900 p-6 text-white shadow-sm">
            ...
            <p className="mt-3 text-sm leading-7 text-white/80">
              Once this UI feels right, we can wire the edit flow to Supabase and
              persist real updates.
            </p>
          </div>
        </div>
      </form>
  ...
  return (
    <div>
      ...
      <select
        ...
        value={value}
        onChange={onChange}
        className="h-12 w-full rounded-2xl border border-stone-200 bg-white px-4 text-sm capitalize outline-none 
transition focus:border-black/30"
      >
        {options.map((option) => (
